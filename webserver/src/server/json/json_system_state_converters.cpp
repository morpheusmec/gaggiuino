...
namespace json {
  ...
  void mapSensorStateToJson(const SensorStateSnapshot& sensorState, JsonObject& target) {
    ...
    target["hotWaterActive"] = sensorState.hotWaterActive;
    target["flushActive"] = sensorState.flushActive;
    target["temperature"] = sensorState.temperature;
    target["waterTemperature"] = sensorState.waterTemperature;
    target["targetTemperature"] = sensorState.targetTemperature;
  ...
  std::string mapDescalingStateToJsonValue(const DescalingState& state) {
    ...
    return "PHASE3";
      case DescalingState::PHASE4:
    return "PHASE4";
      case DescalingState::PHASE5:
      return "PHASE5";
