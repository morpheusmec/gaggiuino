...
public:
  ...
  static bool decoderApply(const ProtoType& proto, LocalType& local) {
    ...
    local.flushActive = proto.flushActive;
...
public:
  static ProtoType encode(const LocalType& local) {
    ...
    case DescalingState::PHASE4: return DescalingStateDto::DescalingStateDto_PHASE4;
    case DescalingState::PHASE5: return DescalingStateDto::DescalingStateDto_PHASE5;
  ...
  static LocalType decode(const ProtoType& proto) {
    ...
    case DescalingStateDto::DescalingStateDto_PHASE4: return DescalingState::PHASE4;
    case DescalingStateDto::DescalingStateDto_PHASE5: return DescalingState::PHASE5;
