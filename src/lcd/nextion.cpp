...
void lcdFetchBrewSettings(GaggiaSettings& settings) {
  ...
  settings.boiler.hpwr                         = myNex.readNumber("bS.homeTime.val");
}
...
void lcdFetchBoiler(GaggiaSettings& settings) {
  ...
  settings.boiler.mainDivider                    = myNex.readNumber("sT.midHeat.val");
  settings.boiler.brewDivider                    = myNex.readNumber("sT.lowHeat.val");
}
